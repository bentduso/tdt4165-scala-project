...
import part2.{Account, Bank, Main, TransactionStatus}

class AccountTests extends AnyFunSuite:
  test("Test 01: Account should be immutable") {
    val account = Account("1234", 500)
...
class AccountTransferTest extends AnyFunSuite:
